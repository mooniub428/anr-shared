function [output_vertices, output_faces] = read_wobj(fullfilename)
...
if(true),disp(['Reading Object file : ' fullfilename]); end
...
while (i<no), i=i+1;
    ...
    if((length(type)==1)&&(type(1)=='f'))
        ...
        output_faces = objects2(index).data.vertices(:,:);
        i=j;
    else
        index=index+1;
